...
<a id="slambuc.alg.tree.dp.seq_state.cacheless_path_tree_partitioning"></a>

#### cacheless\_path\_tree\_partitioning

```python
def cacheless_path_tree_partitioning(tree: nx.DiGraph,
                                     root: int = 1,
                                     M: int = math.inf,
                                     N: int = 1,
                                     L: int = math.inf,
...
<a id="slambuc.alg.tree.dp.seq_state.stateful_path_tree_partitioning"></a>

#### stateful\_path\_tree\_partitioning

```python
def stateful_path_tree_partitioning(tree: nx.DiGraph,
                                    root: int = 1,
                                    M: int = math.inf,
                                    N: int = 1,
                                    L: int = math.inf,
...
<a id="slambuc.alg.ext.greedy.get_min_cpath_split"></a>

#### get\_min\_cpath\_split

```python
def get_min_cpath_split(tree: nx.DiGraph,
                        root: int,
                        cp_end: int,
                        M: int,
                        L: int,
...
<a id="slambuc.alg.ext.greedy.min_lat_partition_heuristic"></a>

#### min\_lat\_partition\_heuristic

```python
def min_lat_partition_heuristic(tree: nx.DiGraph,
                                root: int = 1,
                                M: int = math.inf,
                                L: int = math.inf,
                                N: int = 1,
...
<a id="slambuc.misc.util.get_glpk_path"></a>
